...
const projects: Project[] = [
  { id: 1, title: "Ncell Corporate Gala", category: "Events", year: "2024", type: "image", src: "https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=1200&q=80", thumb: "https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=600&q=80" },
  ...
  { id: 3, title: "Kathmandu Fashion Week", category: "Events", year: "2023", type: "image", src: "https://images.unsplash.com/photo-1509631179647-0c500ab149b5?w=1200&q=80", thumb: "https://images.unsplash.com/photo-1509631179647-0c500ab149b5?w=600&q=80" },
          ...
          >
            {categories.map((cat) => (
              <button
                ...
                className={`font-body uppercase text-xs tracking-widest transition-colors duration-300 ${
                  activeTab === cat ? "text-gold border-b border-gold pb-1" : "text-text-muted hover:text-text-primary pb-1"
                }`}
              >
                {cat}
              </button>
